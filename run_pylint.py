...
https://github.com/PyCQA/pylint/issues/2242#issuecomment-402489261
"""
...
desc = 'PyLint wrapper that add the `--fail-under option`. All other arguments ' \
       'are passed to pylint.'
